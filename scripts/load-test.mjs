...
const PROMPTS = [
  ...
  { selectedCards: [{ group: 'Eix', value: 'Equitat i inclusió' }, { group: 'Usuari final', value: 'Famílies' }, { group: 'Acció principal', value: "Recollir dades i mostrar-les a l'instant" }, { group: 'Repte', value: 'Rebre informació' }, { group: 'Estil', value: 'Alt contrast' }], promptPreview: "Equitat i inclusió · Famílies · Recollir dades · Rebre informació · Alt contrast", format: 'formulari', formatLabel: 'Formulari per a famílies' },
  ...
  { selectedCards: [{ group: 'Eix', value: 'Educació mediàtica' }, { group: 'Usuari final', value: 'Alumnes' }, { group: 'Acció principal', value: 'Classificar informació' }, { group: 'Repte', value: 'Practicar un contingut' }, { group: 'Estil', value: 'Interactiu (botons, controls lliscants i elements per arrossegar)' }], promptPreview: 'Educació mediàtica · Alumnes · Classificar informació · Practicar un contingut · Interactiu', format: 'quiz', formatLabel: 'Quiz interactiu' },
  { selectedCards: [{ group: 'Eix', value: 'Equitat i inclusió' }, { group: 'Usuari final', value: 'Famílies' }, { group: 'Acció principal', value: 'Suggeriments automàtics' }, { group: 'Repte', value: 'Cuidar el benestar' }, { group: 'Estil', value: 'Amb animacions' }], promptPreview: 'Equitat i inclusió · Famílies · Suggeriments automàtics · Cuidar el benestar · Amb animacions', format: 'activitat', formatLabel: "Activitat per a l'aula" },
