...
const PROMPTS = [
  ...
  { label: 'Educació mediàtica', sub: 'Alumnes · Classificar informació · Practicar · Interactiu', selectedCards: [{ group: 'Eix', value: 'Educació mediàtica' }, { group: 'Usuari final', value: 'Alumnes' }, { group: 'Acció principal', value: 'Classificar informació' }, { group: 'Repte', value: 'Practicar un contingut' }, { group: 'Estil', value: 'Interactiu (botons, controls lliscants i elements per arrossegar)' }], format: 'quiz', formatLabel: 'Quiz interactiu' },
  { label: 'Equitat i inclusió', sub: 'Famílies · Suggerències · Benestar · Animacions', selectedCards: [{ group: 'Eix', value: 'Equitat i inclusió' }, { group: 'Usuari final', value: 'Famílies' }, { group: 'Acció principal', value: 'Suggeriments automàtics' }, { group: 'Repte', value: 'Cuidar el benestar' }, { group: 'Estil', value: 'Amb animacions' }], format: 'activitat', formatLabel: "Activitat per a l'aula" },
