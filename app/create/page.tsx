...
const ACCIONS = [
  ...
  { value: 'Recollir dades i mostrar-les a l\'instant', emoji: '📊' },
  { value: 'Suggeriments automàtics', emoji: '🤖' },
...
const ESTILS = [
  ...
  { value: 'Interactiu (botons, controls lliscants i elements per arrossegar)', emoji: '👆' },
        ...
        <div className="flex flex-col px-6 py-6 gap-5" style={{ width: 300, minWidth: 280, flexShrink: 0, borderRight: '1.5px solid var(--border)', position: 'sticky', top: 40, maxHeight: 'calc(100vh - 40px)', overflowY: 'auto' }}>
          ...
          <div className="rounded-xl p-4 flex flex-col gap-2" style={{ background: '#f0fdfb', border: '1.5px solid #0d948825' }}>
            ...
            <ol className="text-sm flex flex-col gap-2" style={{ color: 'var(--body)' }}>
              <li>1. <strong>Escull una targeta de cada color</strong> i completa la frase.</li>
              <li>2. Quan la tinguis completa, prem el <strong>micròfon</strong> i <strong>grava-la</strong>.</li>
              <li>3. Afegeix <strong>context addicional</strong> si la vols personalitzar més (edat, assignatura, durada…).</li>
            </ol>
          </div>
        </div>
