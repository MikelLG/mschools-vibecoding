...
const _ACCIONS  = ['Generar grups','Crear horaris','Classificar informació','Recollir dades i mostrar-les a l\'instant','Suggeriments automàtics','Comparar escenaris (abans/després, opció A/B)','Simular situacions (emocionals, socials, científiques...)','Acompanyar una reflexió emocional','Generar retroalimentació','Facilitar una activitat creativa','Crear un mini-joc','Ruletes, sortejos, targetes aleatòries'];
const _REPTES   = ['Gestió d\'aula','Organització del temps','Comunicació amb famílies','Seguiment de l\'alumnat','Planificació de situacions d\'aprenentatge','Avaluació','Inclusió i accessibilitat','Practicar un contingut','Visualitzar un fenomen','Autoavaluar-se','Regular emocions','Col·laborar en grup','Explorar un concepte','Jugar per aprendre','Rebre informació','Emplenar formularis','Preparar entrevistes','Comprendre rutines','Cuidar el benestar','Seguiment del procés d\'aprenentatge','Complementar l\'aprenentatge des de casa'];
const _ESTILS   = ['Minimalista','Alt contrast','Infantil','Científic','Creatiu / artístic','Ludificat','Amb animacions','Interactiu (botons, controls lliscants i elements per arrossegar)','Narratiu (per passos)'];
